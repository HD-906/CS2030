...
public class PQ2<E> {
     ...
     *         priority queue.
     */
    public PQ2(Comparator<? super E> comparator) {
        this.pq = new PriorityQueue<E>(comparator);
    }

    private PQ2(PQ2<E> source) {
     ...
     */
    public PQ2<E> add(E element) {
        PQ2<E> copy = new PQ2<E>(this);
        copy.pq.add(element);
        return copy;
    }
     ...
     */
    public Pair<E, PQ2<E>> poll() {
        PQ2<E> copy = new PQ2<E>(this);
        E t = copy.pq.poll();
        return new Pair<E,PQ2<E>>(t, copy);
    }
